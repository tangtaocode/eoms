...
public class RedisClient {
	...
	public Object mapGet(String key, String hashKey) {
		Object result = null;
		HashOperations<Object, Object,Object> mapOps = redisTemplate.opsForHash();
		result = mapOps.get(key, hashKey);
		return result;
	}
	public void mapPut(String key, String hashKey,Object value) {
		HashOperations<Object, Object,Object> mapOps = redisTemplate.opsForHash();
		mapOps.put(key, hashKey, value);
	}
	public void mapRemove(String key, String hashKey) {
		HashOperations<Object, Object,Object> mapOps = redisTemplate.opsForHash();
		mapOps.delete(key, hashKey);
		
	}
	public Map<Object,Object> mapGetEntry(String key) {
		Map<Object,Object> result = null;
		HashOperations<Object, Object,Object> mapOps = redisTemplate.opsForHash();
		result = mapOps.entries(key);
		return result;
	}
}
